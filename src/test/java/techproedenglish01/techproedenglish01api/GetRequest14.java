...
//		assertEquals(expectedDataMap.get("SecondHighestSalary"), salaryListInt.get(salaryListInt.size()-2));
		...
		//System.out.println("String list" + salaryListGson);
		//System.out.println("Integer list" + salaryListGsonInt);
		
		Collections.sort(salaryListGsonInt);
		//System.out.println("Sorted List "+salaryListGsonInt);
		...
		//System.out.println("String list" + ageListGson);
		//System.out.println("Integer list" + ageListGsonInt);
		
		Collections.sort(ageListGsonInt);
		//System.out.println("Sorted List "+ageListGsonInt);
		...
		//burada softassertion u ve body yi dene
