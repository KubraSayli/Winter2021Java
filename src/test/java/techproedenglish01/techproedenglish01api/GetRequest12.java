...
public class GetRequest12 extends TestBaseDummy {
	...
	//4) Assert the things which are given in the test case
		...
		System.out.println(actualDataMap);//Normalde automation da syso lar olmaz silmelisin
		...
		//Create a looop to add all employee ages into the list
		...
		//Use containsAll method to check if all the ages are in the age list
